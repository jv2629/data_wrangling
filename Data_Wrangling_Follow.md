...
```
    ...
    ## # A tibble: 49 x 8
    ##    cohort litter_number gd0_weight gd18_weight gd_of_birth pups_born_alive
...
```
    ...
    ##  7 Con8  #3/6/2/2/95-3       NA          NA            20               7
    ...
    ## 18 Low8  #99                 23.5        39            20               6
    ## 19 Low8  #110                25.5        42.7          20               7
